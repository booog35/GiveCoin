...
void ParseParameters(int argc, const char *const argv[]) {
    ...
    // New 0.6 features:
    BOOST_FOREACH(
    const PAIRTYPE(string, string) &entry, mapArgs)
    {
...
boost::filesystem::path GetDefaultDataDir() {
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\GiveCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\GiveCoin
    // Mac: ~/Library/Application Support/GiveCoin
    // Unix: ~/.GiveCoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GiveCoin";
#else
    fs::path pathRet;
...
boost::filesystem::path GetConfigFile() {
    boost::filesystem::path pathConfigFile(GetArg("-conf", "GiveCoin.conf"));
