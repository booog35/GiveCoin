...
void BitcoinGUI::createActions() {
    ...
    aboutAction = new QAction(tr("&About GiveCoin"), this);
...
void BitcoinGUI::setNumBlocks(int count) {
    ...
    if (secs < 90 * 60) {
        ...
        progressBarLabel->setText(
                tr(clientModel->isImporting() ? "Importing blocks..." : "Synchronizing with network..."));
    ...
    if (event->mimeData()->hasUrls()) {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"),
                                tr("URI can not be parsed! This can be caused by an invalid GiveCoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::updateStakingIcon() {
    ...
    if (nLastCoinStakeSearchInterval && nWeight) {
        ...
        labelStakingIcon->setToolTip(
                tr("Staking.<br>Your weight is %1<br>Network weight is %2").arg(nWeight).arg(nNetworkWeight));
    } else {
