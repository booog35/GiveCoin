...
const QString BITCOIN_IPC_PREFIX("givecoin:");
...
bool PaymentServer::ipcSendCommandLine() {
    ...
    foreach(
    const QString &arg, savedPaymentRequests)
    {
...
PaymentServer::PaymentServer(QApplication *parent) : QObject(parent), saveURIs(true) {
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start givecoin: click-to-pay handler");
    else
