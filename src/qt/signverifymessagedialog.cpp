...
SignVerifyMessageDialog::SignVerifyMessageDialog(QWidget *parent) :
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a GiveCoin address (e.g. HG6jDsuUnmmKEiNjVbRmG5vRpMvzUycoaR)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a GiveCoin address (e.g. HG6jDsuUnmmKEiNjVbRmG5vRpMvzUycoaR)"));
